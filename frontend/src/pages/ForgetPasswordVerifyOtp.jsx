...
import ForgetPasswordVerifyButton from "../components/user/forgetpassword/ForgetPasswordVerifyButton";

const ForgetPasswordVerifyOtp = ({ onClose, email, isOpen, userDetail }) => {
