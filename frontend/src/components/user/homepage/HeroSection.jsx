...
<section className="flex relative flex-col justify-center items-center px-5 text-center bg-black h-[718px] overflow-hidden">
  {/* Left Bottom Rotated Image with Motion */}
  <motion.img
    initial={{ x: 10, opacity: 0 }}
    animate={{ x: -110, opacity: 1 }}
    transition={{ duration: 1.5, ease: "easeOut" }}
    src="https://cdn.builder.io/api/v1/image/assets/aadabba814c24e21949a3d066a352728/a22166c626b1d9e0bcb52c2b784432c161305245?placeholderIfAbsent=true"
    className="hidden sm:block absolute bottom-0 left-0 aspect-[1.61] w-[350px] rotate-[180deg]"
    alt="Left Decorative"
  />
  ...
  >
    ...
    <h2 className="text-8xl tracking-tighter uppercase leading-[90px] text-neutral-600 max-md:text-6xl max-md:leading-[70px] max-sm:text-4xl max-sm:leading-[50px]">
  ...
  <motion.img
    ...
    transition={{ duration: 1.5, ease: "easeOut" }}
    src="https://cdn.builder.io/api/v1/image/assets/aadabba814c24e21949a3d066a352728/a22166c626b1d9e0bcb52c2b784432c161305245?placeholderIfAbsent=true"
    className="hidden sm:block absolute top-0 right-0 object-contain w-[350px] aspect-[1.61]"
