...
export const LocationPanel = ({ step, onSelectClick ,locationname}) => {
  const question = step === "pickup"
    ? "WHERE WOULD YOU LIKE TO PICK UP PASSENGER?"
  ...
  return (
    <section className="box-border px-8 py-12 rounded-3xl backdrop-blur-[7.5px] bg-zinc-900 bg-opacity-50 w-full max-w-[511px] mx-auto mb-5 max-md:w-[90%] max-md:px-6 max-md:py-8">
      ...
      <button
        className="text-base font-bold text-black uppercase bg-white h-[62px] rounded-[30px] shadow-[0px_17px_33px_rgba(255,255,255,0.2)] w-full max-w-[436px] mx-auto"
