...
const CounterControls = ({ count, onIncrement, onDecrement }) => {
  return (
    <div className="flex gap-5 items-center">
      <button onClick={onDecrement} className="focus:outline-none border-2 rounded-3xl">
        <svg
          width="34"
          height="34"
          viewBox="0 0 34 34"
      ...
      <button onClick={onIncrement} className="focus:outline-none border-2 rounded-3xl">
        <svg
          width="34"
          height="34"
          viewBox="0 0 34 34"
